...
def cli_parser() -> Tuple[List[str], str]:
  parser = argparse.ArgumentParser(prog = 'sentinel2-mosaic',
  ...
  available_bands = ['B02', 'B03', 'B04', 'B05', 'B06', 'B07', 'B08', 'B8A','B09', 'B11', 'B12']
